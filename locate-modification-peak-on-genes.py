...
def main(argv):
	...
	parser.add_option("-e", "--extension", action="store", type="int", dest="extension", help="upstream and downstream extensions of gene region", metavar="<int>")
	...
	for chrom in chroms:
		if chrom in coords.keys():
			...
			current_genes = associate_island_with_genes.place_domain_summit_on_genes(bed_graph_list, genes, opt.extension)
