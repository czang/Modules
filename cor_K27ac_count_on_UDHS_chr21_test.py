...
def read_hdf5( file_name, sample_names ):
    ...
    # X = None
    chr21_index=range(4474098,4474198)
...
with open("/data5/home/chenfei/JingyuFan/data_collection/MARGE/union_DHS_2016/hg38_H3K27ac_id_peak_more_than_10k.txt","r") as infile:
    temp=[]
    for line in infile:
        if line.strip():
...
DHS_file = "/data/home/czang/cistrome_integration/20160324_chr21_cormap/UDHS_chr22_100.bed"

loc_list =  getLocList(DHS_file)

(x, y, z) = cal_neighboring_cor(data, loc_list)

o = open("/data/home/czang/cistrome_integration/20160324_chr21_cormap/chr21_map.txt",'w')
