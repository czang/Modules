...
def one_chrom_remove(chrom, cutoff):
	...
	(p_total, p_retained) = remove_redundant_1chrom_single_strand_sorted('temp.bed1', outfile, cutoff)
...
def main(argv):
	...
	for chrom in chroms:
		if (Utility.fileExists(chrom + ".bed1")):
			one_chrom_remove(chrom, opt.threshold)
