...
def main(argv):
	...
	parser.add_option("-f", "--outfileforbivalentdomain", action="store", type="string", dest="out_bivalentdomain_file", metavar="<file>", help="output file name for bivalent domains")
	parser.add_option("-o", "--outfileforgenelist", action="store", type="string", dest="out_gene_file", help="output file name for genes with bivalent domains", metavar="<file>")
