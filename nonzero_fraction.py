...
def main(argv):
	...
	parser.add_option("-i", "--index", action="store", type="int", dest="column", metavar="<int>", help="column number, start from 1")
	...
	print get_nonzero_fraction(opt.inputfile, opt.column - 1)
