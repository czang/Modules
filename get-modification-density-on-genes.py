...
def main(argv):
	...
	occupied_genes = {}; # gene name: tag count
	total = 0;
	...
	for chrom in chroms:
		if chrom in coords.keys():
			...
			current_genes = associate_island_with_genes.find_domainread_density_on_genes(bed_graph_list, genes, opt.region_type, opt.promoter_extension);
