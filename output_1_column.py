...
def get_formated_genes(input_file, name, output_file):
	"""
...
def main(argv):
	...
	parser.add_option("-b", "--name", action="store", type="int", dest="name", metavar="<int>", help="colum number for name", default=1)
	...
	get_formated_genes(opt.input_file, opt.name, opt.output_file)
