...
def main(argv):
	...
	for chrom in chroms:
		if chrom in coords.keys():
			...
			tag_count_list = associate_tags_with_regions.find_read_distance_weighted_score_on_regions(tag_position_list, region_start_list, opt.promoter_extension, opt.decayfactor)
