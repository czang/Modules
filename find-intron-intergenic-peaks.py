...
and output those islands that are in intergenic or intron regions. 
...
def get_island_regions(bed_vals, coords, chrom, TSSthreshold):
	...
	return promoter_islands, exon_islands, intron_islands, intergenic_islands, upstream_distances, output_islands
