		...
		if chrom in coords.keys():
			...
			for line in f:
				if not re.match("#", line):
					...
					score_list.append(atof(sline[4]))
			f.close();
			tag_count_list = associate_tags_with_regions.find_read_sumscore_on_regions(tag_position_list, score_list, region_start_list, region_end_list)
