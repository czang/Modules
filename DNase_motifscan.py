...
def main(argv):
	...
	parser.add_option("-f", "--fastafile", action="store", type="string", dest="fafile", metavar="<file>", help="regions to be scanned")
	parser.add_option("-t", "--threshold", action="store", type="float", dest="threshold", help="score cutoff threshold for every scanning window", metavar="<float>", default = 1000)
	...
	motif_matching_score.scan_fasta(opt.fafile, m, DNase_BG_0, opt.threshold, opt.outfile)
