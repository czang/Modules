...
def countTagsInWindow(start, end, tag_starts):
    ...
    end_index = bisect.bisect_right(tag_starts, end)
    return end_index - start_index

def getUpstreamDensities(gene_coords, bed_vals, shift):
    tag_starts = [];
    tag_sums = [];
    seq_sizes = [];
...
def getDownstreamDensities(gene_coords, bed_vals, shift):
    tag_starts = [];
    tag_sums = [];
    seq_sizes = [];
...
def getGenicDensities(gene_coords, bed_vals, shift):
    tag_starts = [];
    tag_sums = [];
    seq_sizes = [];
...
def main(argv):
    ...
    (up_tag_counts, up_seq_sizes) = getUpstreamDensities(gene_coords, bed_vals, shift_length);
    out_ind = 0;
    ...
    (gene_tag_counts, gene_seq_sizes) = getGenicDensities(gene_coords, bed_vals, shift_length);
    ...
    (down_tag_counts, down_seq_sizes) = getDownstreamDensities(gene_coords, bed_vals, shift_length);
