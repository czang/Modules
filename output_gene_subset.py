...
def main(argv):
	...
	parser.add_option("-b", "--infile2", action="store", type="string", dest="subsetfile", metavar="<file>", help="file with gene sub set in the first column")
	...
	output_UCSCsubset_in_file(opt.inputfile, List, opt.out_file)
